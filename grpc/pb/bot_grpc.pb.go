...
func (c *botClient) AddUserGlobalXp(ctx context.Context, in *AddGlobalXp, opts ...grpc.CallOption) (*LevelUp, error) {
	out := new(LevelUp)
	err := c.cc.Invoke(ctx, "/xp.Bot/AddUserGlobalXp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBotServer) AddUserGlobalXp(context.Context, *AddGlobalXp) (*LevelUp, error) {
...
func _Bot_AddUserGlobalXp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddGlobalXp)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BotServer).AddUserGlobalXp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xp.Bot/AddUserGlobalXp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BotServer).AddUserGlobalXp(ctx, req.(*AddGlobalXp))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Bot_AddUserGlobalXp_Handler,
		},
	},
