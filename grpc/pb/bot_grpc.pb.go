...
type BotClient interface {
	UserAddXp(ctx context.Context, in *AddXp, opts ...grpc.CallOption) (*LevelUp, error)
}
...
func (c *botClient) UserAddXp(ctx context.Context, in *AddXp, opts ...grpc.CallOption) (*LevelUp, error) {
	out := new(LevelUp)
	err := c.cc.Invoke(ctx, "/Bot/UserAddXp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BotServer interface {
	UserAddXp(context.Context, *AddXp) (*LevelUp, error)
...
func (UnimplementedBotServer) UserAddXp(context.Context, *AddXp) (*LevelUp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UserAddXp not implemented")
}
...
func _Bot_UserAddXp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddXp)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BotServer).UserAddXp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Bot/UserAddXp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BotServer).UserAddXp(ctx, req.(*AddXp))
	}
...
var Bot_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "UserAddXp",
			Handler:    _Bot_UserAddXp_Handler,
		},
	},
